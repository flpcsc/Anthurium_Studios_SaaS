...
- `apps/web`: Next.js web app with public auth pages and planned dashboard/admin
- `apps/api`: Fastify API with `GET /health`, initial auth routes and user profile routes
- `apps/workers`: minimal long-running background process

Planned evolution:

- `apps/web`: protected dashboard, profile settings and admin
...
- `packages/database/prisma/migrations/20260522090000_add_users/migration.sql`
